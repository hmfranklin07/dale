const toneClass = {
  ...
  /** State page intro: solid white card, sage accent bar (no dot texture). */
  statePage:
    'rounded-3xl border border-sage-200/85 border-l-4 border-l-sage-600 bg-white p-6 shadow-2xl shadow-black/15 ring-1 ring-sage-200/55 sm:p-8 md:p-10',
  sageDark:
