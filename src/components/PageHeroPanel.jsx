...
const toneClass = {
  ...
  /** State page over a photo hero — translucent white glass, rust bar only (no ring/border frame). */
  statePageGlass:
    'rounded-3xl border-0 border-l-4 border-solid bg-white/62 p-6 shadow-none backdrop-blur-md sm:p-8 md:p-10',
  sageDark:
