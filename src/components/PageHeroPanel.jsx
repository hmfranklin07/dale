...
const toneClass = {
  ...
  /** State page over a photo hero — milky white: readable but photo still visible; rust bar only. */
  statePageGlass:
    'rounded-3xl border-0 border-l-4 border-solid bg-white/56 p-6 shadow-none backdrop-blur-md sm:p-8 md:p-10',
  sageDark:
