...
const toneClass = {
  ...
  /** State page over a photo hero — solid white, rust bar only (no ring/border frame, no blur). */
  statePageGlass:
    'rounded-3xl border-0 border-l-4 border-solid bg-white p-6 shadow-none sm:p-8 md:p-10',
  sageDark:
