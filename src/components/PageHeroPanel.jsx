...
const toneClass = {
  ...
  /** NY over photo: same frame as `statePage`, ~half-opacity true white (theme `white` is cream) + blur so the image shows through. */
  statePageCompact:
    'rounded-3xl border border-sage-300/90 border-l-4 bg-[rgba(255,255,255,0.5)] px-6 py-3 shadow-2xl shadow-black/[0.1] ring-2 ring-sage-400/50 backdrop-blur-md sm:px-8 sm:py-4 md:px-10 md:py-5',
  sageDark:
