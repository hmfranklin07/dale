...
export default function StateVideoTeaser({ vlog, stateSlug }) {
  return (
    ...
    >
      <article className="card group flex h-full flex-col overflow-hidden border-2 border-rust-400/85 !ring-rust-300/50 ring-2 transition-shadow hover:border-rust-500/90 hover:shadow-lg hover:shadow-rust-900/15">
