...
export default function Vlog() {
  return (
    <>
      <section className="bg-gradient-to-b from-earth-100/95 to-sage-100/90 py-16 sm:py-20">
      ...
      <div className="page-container">
        <div className="max-w-3xl mx-auto space-y-20">
          ...
          <section>
            ...
            <p className="text-earth-700 mb-6">Follow the trip in motion on the channels I update most often.</p>
          ...
          <section>
            ...
            <p className="text-earth-700 mb-8">Longer posts about what I saw, who I met, and how each place is shaping the project.</p>
